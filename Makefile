...
LIBOBJECTS := $(OBJ_DIR)/astNode.o $(OBJ_DIR)/astNodeArray.o $(OBJ_DIR)/astNodeAssign.o $(OBJ_DIR)/astNodeBinary.o $(OBJ_DIR)/astNodeBlock.o $(OBJ_DIR)/astNodeBoolean.o $(OBJ_DIR)/astNodeBreak.o $(OBJ_DIR)/astNodeCast.o $(OBJ_DIR)/astNodeContinue.o $(OBJ_DIR)/astNodeDoWhile.o $(OBJ_DIR)/astNodeFor.o $(OBJ_DIR)/astNodeFunctionCall.o $(OBJ_DIR)/astNodeFunctionDeclaration.o $(OBJ_DIR)/astNodeIfElse.o $(OBJ_DIR)/astNodeIndex.o $(OBJ_DIR)/astNodeFloat.o $(OBJ_DIR)/astNodeIdentifier.o $(OBJ_DIR)/astNodeInteger.o $(OBJ_DIR)/astNodeLibrary.o $(OBJ_DIR)/astNodeMap.o $(OBJ_DIR)/astNodePeriod.o $(OBJ_DIR)/astNodePrint.o $(OBJ_DIR)/astNodeRangedFor.o $(OBJ_DIR)/astNodeReturn.o $(OBJ_DIR)/astNodeSlice.o $(OBJ_DIR)/astNodeString.o $(OBJ_DIR)/astNodeTernary.o $(OBJ_DIR)/astNodeUnary.o $(OBJ_DIR)/astNodeUse.o $(OBJ_DIR)/astNodeWhile.o $(OBJ_DIR)/context.o $(OBJ_DIR)/computedExpression.o $(OBJ_DIR)/computedExpressionArray.o $(OBJ_DIR)/computedExpressionBoolean.o $(OBJ_DIR)/computedExpressionCompiledFunction.o $(OBJ_DIR)/computedExpressionFloat.o $(OBJ_DIR)/computedExpressionInteger.o $(OBJ_DIR)/computedExpressionIterator.o $(OBJ_DIR)/computedExpressionIteratorEnd.o $(OBJ_DIR)/computedExpressionError.o $(OBJ_DIR)/computedExpressionLibrary.o $(OBJ_DIR)/computedExpressionLibraryMath.o $(OBJ_DIR)/computedExpressionMap.o $(OBJ_DIR)/computedExpressionNativeBoundFunction.o $(OBJ_DIR)/computedExpressionNativeFunction.o $(OBJ_DIR)/computedExpressionNativeLibraryFunction.o $(OBJ_DIR)/computedExpressionString.o $(OBJ_DIR)/error.o $(OBJ_DIR)/garbageCollected.o $(OBJ_DIR)/htmlEscape.o $(OBJ_DIR)/htmlEscapeAscii.o $(OBJ_DIR)/program.o $(OBJ_DIR)/program-dumpBytecode.o  $(OBJ_DIR)/program-execute.o $(OBJ_DIR)/tangBase.o $(OBJ_DIR)/tangParser.o $(OBJ_DIR)/tangScanner.o $(OBJ_DIR)/unescape.o $(OBJ_DIR)/unicodeString.o
