...
#ifndef TANG_UNESCAPE_HPP
#define TANG_UNESCAPE_HPP
...
namespace Tang {
   ...
   */
  class Unescape : public yyFlexLexer {
  public:
    /**
     ...
     */
    Unescape(std::istream& arg_yyin, std::ostream& arg_yyout) : yyFlexLexer(arg_yyin, arg_yyout) {}
