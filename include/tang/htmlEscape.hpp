...
#ifndef TANG_HTMLESCAPE_HPP
#define TANG_HTMLESCAPE_HPP
...
namespace Tang {
   ...
   */
  class HtmlEscape : public yyFlexLexer {
  public:
    /**
     ...
     */
    HtmlEscape(std::istream& arg_yyin, std::ostream& arg_yyout) : yyFlexLexer(arg_yyin, arg_yyout) {}
