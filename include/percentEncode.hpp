/**
 * @file
 * Declare the Tang::PercentEncode used to tokenize a Tang script.
 */

#ifndef TANG_PERCENTENCODE_HPP
#define TANG_PERCENTENCODE_HPP
...
#ifndef FLEXINT_H
#undef yyFlexLexer
#define yyFlexLexer TangPercentEncodeFlexLexer
#include <FlexLexer.h>
#endif //FLEXINT_H
...
#undef YY_DECL
#define YY_DECL std::string Tang::PercentEncode::get_next_token()
...
namespace Tang {
  ...
  public:
     ...
     */
    PercentEncode(std::istream& arg_yyin, std::ostream& arg_yyout) : yyFlexLexer(arg_yyin, arg_yyout) {}
