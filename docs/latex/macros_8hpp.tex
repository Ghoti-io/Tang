...
\begin{center}
\leavevmode
\includegraphics[width=192pt]{macros_8hpp__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em A function pointer that will be executed as bound to an object. \end{DoxyCompactList}\end{DoxyCompactItemize}
